        ...
        private void runTransFourFive(Session session, ItemsMetadata itemsMetadata) {
                ...
                for (int i = 0; i < items.length; i++) {
                        ...
                        int update_remote_cnt = s_remote_cnt
                                        + (Integer.parseInt(warehouse_id) != ol_supply_w_id ? 1 : 0);
                        ...
                        String updateStock = String.format(
                                        ...
                                        adj_qty, update_ytd, update_order_cnt, update_remote_cnt, ol_supply_w_id,
                                        ol_i_id);
                ...
                BoundStatement bound_tx5 = ps_tx5.bind(Integer.parseInt(warehouse_id), Integer.parseInt(district_id),
                                order_id, Integer.parseInt(this.customer_id),
                                currDate, null, null, customer.getString("C_FIRST"), customer.getString("C_MIDDLE"),
